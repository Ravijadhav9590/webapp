...
import { Form, Input, Button, Row, Select, DatePicker, Tooltip } from "antd";
import {
  UserOutlined,
  EyeTwoTone,
...
function FirstPage({ firstPageData, onNexPageClick }) {
  return (
    <Form
      layout="vertical"
    ...
    >
      ...
      <Form.Item
        ...
        rules={[{ required: true }]}
      >
        <Input placeholder="Input ethnicity" allowClear />
      </Form.Item>
